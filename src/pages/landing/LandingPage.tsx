    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black text-white pt-20">
        ...
        <div className="relative z-10 max-w-5xl text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-tight mb-6">
              Temukan Dunia Manga
              <br />
              <span className="text-primary">di MangaKyy</span>
            </h1>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center bg-gray-900 border border-gray-800 rounded-3xl p-12">
          ...
          <h2 className="text-4xl font-bold mb-4">Mulai Petualangan Membaca</h2>

          <p className="text-gray-400 mb-8">
            Temukan manga favoritmu dan nikmati ribuan chapter gratis di
            MangaKyy.
          </p>
