...
export default function HomePage() {
  const { recommendation, popular, update } = useLoaderData({ from: '/home' })

  return (
    <div className="font-primary flex flex-col w-full min-h-screen px-2 md:px-20 pt-16 md:pt-20 pb-16 md:pb-0">
        ...
        <div className="flex flex-col items-start justify-between lg:flex-row w-full h-auto gap-5">
          <div className="flex flex-col w-[100%] lg:w-[68%] min-h-screen gap-5">
            <RecommendationSection
              recommendation={recommendation?.data as ComicType[]}
            />
